...
# ============================================================================
TASK_NAME="${TASK_NAME:-click_alarmclock}"  # Change this to the task you want to test
GPU_ID="${GPU_ID:-6}"                     # GPU to use
TEST_NUM="${TEST_NUM:-100}"               # Number of evaluation episodes
